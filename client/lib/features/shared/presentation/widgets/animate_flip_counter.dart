// See lib here: https://github.com/h65wang/flutter-animated-counter/tree/master
import 'dart:math' as math;

import 'package:flutter/material.dart';

/// A counter that animates between values.
class AnimatedFlipCounter extends StatelessWidget {
  ...
  /// Default value [Durations.extralong1]
  final Duration duration;

  /// Animation duration for the negative sign to appear and disappear.
  /// Default value is [Durations.short3] so it feels snappy.
  ...
  /// Creates a new [AnimatedFlipCounter] instance.
  const AnimatedFlipCounter({
    required this.value,
    super.key,
    this.duration = Durations.extralong1,
    this.negativeSignDuration = Durations.short3,
