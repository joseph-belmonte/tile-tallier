...
import '../../application/providers/key_value_db_provider.dart';
...
class SettingsEntry<T> extends Notifier<T> {
  /// Constructor for the [SettingsEntry].
  SettingsEntry({
    required this.key,
  ...
  void init() {
    ...
    final db = ref.read(keyValueDbProvider);
    ...
    final newValue = db.get(key, defaultValue);
